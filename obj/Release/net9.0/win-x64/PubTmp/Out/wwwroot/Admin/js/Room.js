...
loaddata = function () {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Room/listdata", // Gọi file PHP xử lý
        type: "GET",
...
LoadModelAdd = function () {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Room/Create", // Gọi file PHP xử lý
        type: "GET",
        success: function (response) {
            UnBlockUI();
...
LoadModelEdit = function (id) {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Room/Edit", // Gọi file PHP xử lý
        type: "GET",
        data: { id: id },
        success: function (response) {
            UnBlockUI();
...
LoadModelDetail = function (id) {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Room/Detail", // Gọi file PHP xử lý
        type: "GET",
        data: { id: id },
        success: function (response) {
            UnBlockUI();
...
editVacuity = function (id) {

    BlockUI(); // Không cho người dùng nhập liệu khi đang thao tác với dữ liệu
    $.ajax({
        url: "/Admin/Room/Vacuity",
        type: "POST",
        data: { id: id },
        success: function (res) {
            UnBlockUI();
