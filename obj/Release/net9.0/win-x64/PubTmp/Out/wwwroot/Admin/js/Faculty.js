...
loaddata = function () {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Faculty/listdata", // Gọi file PHP xử lý
        type: "GET",
...
LoadModelAdd = function () {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Faculty/Create", // Gọi file PHP xử lý
        type: "GET",
        success: function (response) {
            UnBlockUI();
...
LoadModelEdit = function (id) {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Faculty/Edit", // Gọi file PHP xử lý
        type: "GET",
        data: { id: id },
        success: function (response) {
            UnBlockUI();
...
LoadModelDetail = function (id) {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Faculty/Detail", // Gọi file PHP xử lý
        type: "GET",
        data: { id: id },
        success: function (response) {
            UnBlockUI();
