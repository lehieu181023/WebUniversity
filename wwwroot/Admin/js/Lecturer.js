...
loaddata = function () {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Lecturer/listdata", // Gọi file PHP xử lý
        type: "GET",
...
LoadModelAdd = function () {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Lecturer/Create", // Gọi file PHP xử lý
        type: "GET",
        success: function (response) {
            UnBlockUI();
...
LoadModelEdit = function (id) {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Lecturer/Edit", // Gọi file PHP xử lý
        type: "GET",
        data: { id: id },
        success: function (response) {
            UnBlockUI();
...
LoadModelDetail = function (id) {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Lecturer/Detail", // Gọi file PHP xử lý
        type: "GET",
        data: { id: id },
        success: function (response) {
            UnBlockUI();
...
function LoadModeCreateAcount() {
    ...
    BlockUI();
    $.ajax({
        url: "/Admin/Lecturer/CreateAccount",
        type: "Get",
